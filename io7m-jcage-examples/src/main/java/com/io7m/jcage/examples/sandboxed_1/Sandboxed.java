...
@SuppressWarnings("synthetic-access") public final class Sandboxed implements
  Runnable
{
  private static void tryPrivileged()
  {
    System.out
      .println("Sandboxed: Attempting to perform privileged operation");
    ...
    try {
      ...
      System.out
        .println("Sandboxed: Correctly failed to perform privileged operation: "
          + e.getMessage());
    }
  }
